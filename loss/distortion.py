    ...
    def __init__(self, args):
        ...
        if args.distortion_metric == 'MSE':
            ...
            if args.trainset == 'CIFAR10':
                self.dist = MS_SSIM(window_size=3, data_range=1., levels=4, channel=3).cuda(args.local_rank)
            else:
                self.dist = MS_SSIM(data_range=1., levels=4, channel=3).cuda(args.local_rank)
        else:
            raise ValueError
